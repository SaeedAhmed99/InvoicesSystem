                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" name='save_product'>تاكيد</button>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('product.update') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">اسم المنتج</label>
                                <input type="number" class="form-control" id="pro_id" name="pro_id" required hidden>
                                <input type="text" class="form-control" id="product_name" name="product_name" required>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success" name='edit_product'>تاكيد</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
                        </div>
                    </form>
                </div>

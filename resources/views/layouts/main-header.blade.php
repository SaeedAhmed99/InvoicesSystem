								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{route('markAsReadAll')}}">تعين قراءة الكل</a></span>	
										</div>
										<p id='notifications_count' class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير مقروءة: {{auth()->user()->unreadNotifications()->count()}}</p>
									</div>
									<div class="main-notification-list Notification-scroll" id='unreadNotifications'>
										@foreach(auth()->user()->unreadNotifications as $notification)
											<a class="d-flex p-3 border-bottom" href="{{route('invoice.details.show', $notification->data['id'])}}">
												<div class="mr-3">
